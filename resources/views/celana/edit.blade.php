    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-white-primary elevation-4">
            ...
            <a href="/admin/home" class="brand-link">
                <img src="{{ asset('image/images.png') }}" alt="AdminLTE Logo"
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 shadow-sm rounded">
                            <div class="card-body">
                                <form action="{{ route('celana.update', $celanas->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="nama_produk" value="{{ old('nama_produk', $celanas->nama_produk) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('stok') is-invalid @enderror"
                                            name="stok" value="{{ old('stok', $celanas->stok) }}"
                                            placeholder="Masukkan Judul Post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" rows="5"
                                            placeholder="Masukkan Konten Post">{{ old('deskripsi', $celanas->deskripsi) }}</textarea>
