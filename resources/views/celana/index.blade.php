      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('celana.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              @forelse ($celanas as $data)
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/celana/'.$data->image) }}" class="rounded" style="width: 150px">
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('celana.destroy', $data->id) }}" method="POST">
                                            <a href="{{ route('celana.show', $data->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                            <a href="{{ route('celana.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
