...
<head>
  ...
  <title>Halaman Index Trousers</title>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('trousers.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              @forelse ($trouser as $data)
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/trousers/'.$data->image) }}" class="rounded" style="width: 150px">
                                    </td>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/trousers/'.$data->foto_depan) }}" class="rounded" style="width: 150px">
                                    </td>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/trousers/'.$data->foto_belakang) }}" class="rounded" style="width: 150px">
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('trousers.destroy', $data->id) }}" method="POST">
                                            <a href="{{ route('trousers.show', $data->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                            <a href="{{ route('trousers.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
