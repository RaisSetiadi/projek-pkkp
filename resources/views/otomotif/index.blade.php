...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <h5 class="text-center"><a href="https://santrikoding.com">www.santrikoding.com</a></h5>          -->
                        ...
                        <div class="card border-0 shadow-sm rounded">
                            <div class="card-body">
                                <a href="{{ route('otomotif.create') }}" class="btn btn-md btn-success mb-3">TAMBAH
                                    POST</a>
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @forelse ($kendaraans as $data)
                                        <tr>
                                            <td class="text-center">
                                                <img src="{{ asset('/storage/otomotif/' . $data->image) }}" class="rounded" style="width: 150px">
                                            </td>
                                            <td class="text-center">
                                                <img src="{{ asset('/storage/otomotif/' . $data->foto_depan) }}" class="rounded" style="width: 150px">
                                            </td>
                                            <td class="text-center">
                                                <img src="{{ asset('/storage/otomotif/' . $data->foto_belakang) }}" class="rounded" style="width: 150px">
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('otomotif.destroy', $data->id) }}" method="POST">
                                                    <a href="{{ route('otomotif.show', $data->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                                    <a href="{{ route('otomotif.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                    @csrf
                                                    @method('DELETE')
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2014-2021 <a href="#">Website Ecommarce</a>.</strong>
            PI MART 52
