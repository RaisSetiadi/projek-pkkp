        ...
        <div class="row justify-content-center">
            ...
            @foreach ($posts as $post)
                <div class="col-md-3 mb-5 apparel">
                    <div class="card">
                        <a href="{{ route('pesan.pakaian', $post->id) }} "> <img
                                src="{{ asset('/storage/posts/' . $post->image) }}" class="card-img-top"
                                alt="..."></a>
                        <div class="card-body">
        ...
        <div class="row justify-content-center">
            ...
            @foreach ($bajus as $data)
                <div class="col-md-3 mt-5 Tshirt">
                    <div class="card">
                        <a href="{{ route('pesan.baju', $data->id) }} "> <img
                                src="{{ asset('/storage/baju/' . $data->image) }}" class="card-img-top"
                                alt="..."></a>
                        <div class="card-body">
        ...
        <div class="row justify-content-center">
            ...
            @foreach ($celanas as $data)
                <div class="col-md-3 mt-5 celana">
                    <div class="card">
                        <a href="{{ route('pesan.celana', $data->id) }} "> <img
                                src="{{ asset('/storage/celana/' . $data->image) }}" class="card-img-top"
                                alt="..."></a>
                        <div class="card-body">
                            <h5 class="card-title">{{ $data->nama_produk }}</h5>
                            <p class="card-text">IDR {{ $data->harga }}</p>
        ...
        <div class="row justify-content-center">
            ...
            @foreach ($kacamatas as $data)
                <div class="col-md-3 mt-5 kacamata">
                    <div class="card">
                        <a href="{{ route('pesan.kacamata', $data->id) }} "> <img
                                src="{{ asset('/storage/kacamata/' . $data->image) }}" class="card-img-top"
                                alt="..."></a>
                        <div class="card-body">
                            <h5 class="card-title">{{ $data->nama_produk }}</h5>
                            <p class="card-text">IDR {{ $data->harga }}</p>
        ...
        <div class="row justify-content-center">
            ...
            @foreach ($topis as $data)
                <div class="col-md-3 mt-5 topi">
                    <div class="card">
                        <a href="{{ route('pesan.topi', $data->id) }} "> <img
                                src="{{ asset('/storage/topi/' . $data->image) }}" class="card-img-top"
                                alt="..."></a>
                        <div class="card-body">
                            <h5 class="card-title">{{ $data->nama_produk }}</h5>
                            <p class="card-text">IDR {{ $data->harga }}</p>
