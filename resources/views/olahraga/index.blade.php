                ...
                <div class="container-fluid">
                    ...
                    <h5 class="text-center"><a href="https://santrikoding.com">www.santrikoding.com</a></h5>          -->
                        ...
                        <div class="card border-0 shadow-sm rounded">
                            <div class="card-body">
                                <a href="{{ route('olahraga.create') }}" class="btn btn-md btn-success mb-3">TAMBAH
                                    POST</a>
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @forelse ($olahragas as $data)
                                            <tr>
                                                <td class="text-center">
                                                    <img src="{{ asset('/storage/olahraga/' . $data->image) }}"
                                                        class="rounded" style="width: 150px">
                                                </td>
                                                <td class="text-center">
                                                    <img src="{{ asset('/storage/olahraga/' . $data->foto_depan) }}"
                                                        class="rounded" style="width: 150px">
                                                </td>
                                                <td class="text-center">
                                                    <img src="{{ asset('/storage/olahraga/' . $data->foto_belakang) }}"
                                                        class="rounded" style="width: 150px">
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                        action="{{ route('olahraga.destroy', $data->id) }}"
                                                        method="POST">
                                                        <a href="{{ route('olahraga.show', $data->id) }}"
                                                            class="btn btn-sm btn-dark">SHOW</a>
                                                        <a href="{{ route('olahraga.edit', $data->id) }}"
