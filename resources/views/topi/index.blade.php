      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('topi.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              @forelse ($topis as $data)
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/topi/'.$data->image) }}" class="rounded" style="width: 150px">
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('topi.destroy', $data->id) }}" method="POST">
                                            <a href="{{ route('topi.show', $data->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                            <a href="{{ route('topi.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
