...
<head>
  ...
  <title>Halaman Index Sneakers</title>
      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('sneakers.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                            ...
                            <tbody>
                              @forelse ($sneaker as $data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('sneakers.destroy', $data->id) }}" method="POST">
                                            <a href="{{ route('sneakers.show', $data->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                            <a href="{{ route('sneakers.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
