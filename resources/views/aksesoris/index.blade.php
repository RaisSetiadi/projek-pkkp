      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('aksesoris.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              @forelse ($aksesoris as $data)
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/aksesoris/'.$data->image) }}" class="rounded" style="width: 100px">
                                    </td>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/aksesoris/'.$data->foto_depan) }}" class="rounded" style="width: 100px">
                                    </td>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/aksesoris/'.$data->foto_belakang) }}" class="rounded" style="width: 100px">
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('aksesoris.destroy', $data->id) }}" method="POST">
                                            <a href="{{ route('aksesoris.show', $data->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                            <a href="{{ route('aksesoris.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
