                ...
                <div class="container-fluid">
                    ...
                    <h5 class="text-center"><a href="https://santrikoding.com">www.santrikoding.com</a></h5>          -->
                        ...
                        <div class="card border-0 shadow-sm rounded">
                            <div class="card-body">
                                <a href="{{ route('MinumanSehat.create') }}" class="btn btn-md btn-success mb-3">TAMBAH
                                    POST</a>
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @forelse ($minumans as $data)
                                            <tr>
                                                <td class="text-center">
                                                    <img src="{{ asset('/storage/MinumanSehat/' . $data->image) }}"
                                                        class="rounded" style="width: 150px">
                                                </td>
                                                <td class="text-center">
                                                    <img src="{{ asset('/storage/MinumanSehat/' . $data->foto_depan) }}"
                                                        class="rounded" style="width: 150px">
                                                </td>
                                                <td class="text-center">
                                                    <img src="{{ asset('/storage/MinumanSehat/' . $data->foto_belakang) }}"
                                                        class="rounded" style="width: 150px">
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                        action="{{ route('MinumanSehat.destroy', $data->id) }}"
                                                        method="POST">
                                                        <a href="{{ route('MinumanSehat.show', $data->id) }}"
                                                            class="btn btn-sm btn-dark">SHOW</a>
                                                        <a href="{{ route('MinumanSehat.edit', $data->id) }}"
