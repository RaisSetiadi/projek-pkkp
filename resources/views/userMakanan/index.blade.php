...
<body>
        ...
        <div class="row justify-content-center">
            ...
            @foreach ($trouser as $data)
                <div class="col-md-3 mb-5 hot-product">
                    <div class="card">
                        <a href="{{ route('pesan.makanan', $data->id) }}"> <img
                                src="{{ asset('/storage/trousers/' . $data->image) }}" class="card-img-top"
                                alt="..."></a>
                        <div class="card-body">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 judul-makmin">
                <h2>Makanan dan Minuman</h2>
            </div>
            @foreach ($trouser as $data)
                <div class="col-md-3 mt-5 mb-5 makmin">
                    <div class="card">
                    <a href="{{ route('pesan.makanan', $data->id) }}"> <img src="{{ asset('/storage/trousers/' . $data->image) }}" class="card-img-top"
                            alt="..."></a>
                        <div class="card-body">
                            <h5 class="card-title">{{ $data->nama_produk }}</h5>
                            <p class="card-text">IDR {{ $data->harga }}</p>
        ...
        <div class="row justify-content-center">
            ...
            @foreach ($makanans as $data)
                <div class="col-md-3 makanan">
                    <div class="card">
                    <a href="{{ route('userMakanan.detailmakanan', $data->id) }}">  <img src="{{ asset('/storage/MakananSehat/' . $data->image) }}" class="card-img-top"
                            alt="..."></a>
                        <div class="card-body">
                            <h5 class="card-title">{{ $data->nama_produk }}</h5>
                            <p class="card-text">IDR {{ $data->harga }}</p>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            @foreach ($minumans as $data)
                <div class="col-md-3 minuman">
                    <div class="card">
                    <a href="{{ route('userMakanan.detailminuman', $data->id) }}"><img src="{{ asset('/storage/MinumanSehat/' . $data->image) }}" class="card-img-top"
                            alt="..."></a>
                        <div class="card-body">
                            <h5 class="card-title">{{ $data->nama_produk }}</h5>
                            <p class="card-text">IDR {{ $data->harga }}</p>
