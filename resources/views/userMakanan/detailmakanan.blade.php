                        ...
                        <div class="row">
                                ...
                                <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('/storage/MakananSehat/' . $makanans->image) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/MakananSehat/' . $makanans->foto_depan) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/MakananSehat/' . $makanans->foto_belakang) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 deskripsi">
                                ...
                                <center>
                                    ...
                                    <div data-tooltip="{{ $makanans->harga }}" class="button">
