...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-body-tertiary">
        <div class="container-fluid">
            <a href="/home"><img src="{{ asset('pkkpp/pi_mart.jpg') }}" alt="" srcset=""
                    style="height:55px; margin-left:20px;"></a>
                        ...
                        <div class="row">
                                ...
                                <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('/storage/MinumanSehat/' . $minumans->image) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/MinumanSehat/' . $minumans->foto_depan) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/MinumanSehat/' . $minumans->foto_belakang) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 deskripsi">
                                ...
                                <center>
                                    ...
                                    <div data-tooltip="{{ $minumans->harga }}" class="button">
