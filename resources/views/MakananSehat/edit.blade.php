      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('MakananSehat.update', $makanans->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_produk') is-invalid @enderror" name="nama_produk" value="{{ old('nama_produk', $makanans->nama_produk) }}" placeholder="Masukkan Judul Post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('harga') is-invalid @enderror" name="harga" value="{{ old('harga', $makanans->harga) }}" placeholder="Masukkan Judul Post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('stok') is-invalid @enderror" name="stok" value="{{ old('stok', $makanans->stok) }}" placeholder="Masukkan Judul Post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" rows="5" placeholder="Masukkan Konten Post">{{ old('deskripsi', $makanans->deskripsi) }}</textarea>
