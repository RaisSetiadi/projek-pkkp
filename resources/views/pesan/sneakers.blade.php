...
<head>
    ...
    <title>Halaman Keterangan Produk Sneakers</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-body-tertiary">
        <div class="container-fluid">
            <a href="/home"><img src="{{ asset('image/logoPi.jpeg') }}" alt="" srcset=""
                    style="height:100px; margin-left:20px;"></a>
            ...
            <center>
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page"
                                href="{{ route('userBarangbekas.index') }}">Barang Second</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page"
                                href="{{ route('userMakanan.index') }}">Makanan</a>
                        </li>
                        <!-- search -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('/storage/sneakers/' . $sneaker->image) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/sneakers/' . $sneaker->foto_depan) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/sneakers/' . $sneaker->foto_belakang) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 foto">
                                    <img src="{{ asset('/storage/sneakers/' . $sneaker->foto_depan) }}"
                                        style="width: 250px; height: 210px;" alt="">
                                </div>
                                <div class="col-md-6 foto">
                                    <img src="{{ asset('/storage/sneakers/' . $sneaker->foto_belakang) }}"
                                        style="width: 250px; height: 210px; display:flex;" alt="">
                                </div>
                            </div>

                            <div class="col-md-6 deskripsi">
                                <h4>{{ $sneaker->nama_produk }}</h4>
                                <p>Start from</p>
                                <table class="table1">
                                    <tbody>
                                        <tr>
                                ...
                                <center>
                                    <form action="#" method="POST">
                                        ...
                                        <div class="d-grid gap-2 col-6 mx-auto" style="margin-top:40px;">
                                            <button type="submit" class="btn btn-dark">Masukkan Keranjang</button>
                                        </div>
                                    </form>
                                    <div data-tooltip="{{ $sneaker->harga }}" class="button">
                                ...
                                <div class="col-md-12 note">
                                    <h4>Note</h4>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam possimus ut
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3 logo-perusahaan">
                    <img src="{{ asset('image/buat.png') }}"
                        style="width:100px ; height:130px; margin-left:80px; margin-top:30px;" alt=""
                        srcset="">
                </div>
                <div class="col-md-2">
