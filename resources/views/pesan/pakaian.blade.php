                        ...
                        <div class="row">
                            ...
                            <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        ...
                                        <img src="{{ asset('/storage/posts/'.$posts->foto_depan) }}"
                                            class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                        <img src="{{ asset('/storage/posts/'.$posts->foto_belakang) }}"
                                            class="rounded mx-auto d-block " alt="...">
                                        </div>
                                    </div>
                                   ...
                                   <img src="{{ asset('/storage/posts/'.$posts->foto_depan) }}" style="width: 250px; height: 210px;" alt="">
                                </div>  
                                <div class="col-md-6 foto">
                                <img src="{{ asset('/storage/posts/'.$posts->foto_belakang) }}" style="width: 250px; height: 210px; display:flex;" alt="">
                                </div>  
                            </div>
                            <div class="col-md-6 deskripsi">
                                ...
                                <center>
                                    <form action="{{ route('pesan.pesan', $posts->id) }}" method="POST">
                                        @csrf
                                        <input type="text" class="form-control" name="jumlah_pesan" required="">
