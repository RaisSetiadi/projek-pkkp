                                ...
                                <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('/storage/topi/' . $topis->image) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/topi/' . $topis->foto_depan) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/topi/' . $topis->foto_belakang) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 deskripsi">
                                ...
                                <center>
                                    <div class="d-grid gap-2 col-6 mx-auto" style="margin-top:40px;">
                                        <a href="{{ route('pesan.pesan', $topis->id) }}"class="btn btn-dark"
                                            type="button">Brand New</a>
                                    </div>
                                    <div data-tooltip="{{ $topis->harga }}" class="button">
