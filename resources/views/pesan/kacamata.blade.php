                                ...
                                <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('/storage/kacamata/' . $kacamatas->image) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/kacamata/' . $kacamatas->foto_depan) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/kacamata/' . $kacamatas->foto_belakang) }}"
                                                class="rounded mx-auto d-block " alt="...">
                                        </div>
                                    </div>
                                ...
                                <table class="table1">
                                    <tbody>
                                        <tr>
                                            <td>IDR</td>
                                            <td></td>
                                            <td>{{ $kacamatas->harga }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <center>
                                    <div class="d-grid gap-2 col-6 mx-auto" style="margin-top:40px;">
                                        <a href="{{ route('pesan.pesan', $kacamatas->id) }}"class="btn btn-dark"
                                            type="button">Brand New</a>
                                    </div>
                                    <div data-tooltip="{{ $kacamatas->harga }}" class="button">
